...
#define CONTAINER_ALL CONTAINER_BLOOD_ALL + LIQUID_WATER + LIQUID_RIVERWATER + LIQUID_VODKA + LIQUID_BEER + LIQUID_GASOLINE + LIQUID_DIESEL + LIQUID_DISINFECTANT + LIQUID_SOLUTION
